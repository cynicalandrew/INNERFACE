...
function handleButtonClick(buttonFanTwo){
  togglePin(3);
}
function handleButtonClick(buttonMatrixOne){
  togglePin(4);
}
function handleButtonClick(buttonMatrixTwo){
  togglePin(14);
}
function handleButtonClick(buttonLED){
  togglePin(15);
}
